...
export const TABS: Tab[] = [
  ...
  { id: "renewal", label: "Renewal Intelligence", path: "/renewal", group: "Strategic", wired: true },
  { id: "savings-sandbox", label: "Benefit & Savings Sandbox", path: "/savings-sandbox", group: "Strategic", wired: true },
  { id: "balanced-design", label: "Balanced Benefit Design", path: "/balanced-design", group: "Strategic", wired: true },
