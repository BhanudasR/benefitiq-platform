...
describe("Claims dashboard", () => {
  it("renders governed KPIs and charts", async () => {
    ...
    expect(screen.getByTestId("claims-kpi-claimed")).toHaveTextContent("Not Available");
    expect(screen.getByTestId("claims-kpi-frequency")).toHaveTextContent("Not Available");
    expect(screen.getByTestId("claims-kpi-claimants")).toHaveTextContent("Not Available");
    expect(screen.getByTestId("claims-paid-outstanding")).toBeInTheDocument();
    expect(screen.getByTestId("claims-trend")).toBeInTheDocument();
    expect(screen.getByTestId("claims-large-aggregate")).toHaveTextContent("3");
    expect(screen.getByTestId("claims-frequency-severity")).toHaveTextContent("Not Available");
    expect(screen.getByTestId("claims-alerts")).toBeInTheDocument();
    expect(screen.getByTestId("claims-opportunities")).toBeInTheDocument();
    expect(screen.getByTestId("claims-action-center")).toBeInTheDocument();
    expect(screen.getByTestId("claims-evidence-footer")).toBeInTheDocument();
...
describe("Ailment dashboard", () => {
  it("renders top ailments, quadrant and recurring groups from API", async () => {
    ...
    expect(screen.getByTestId("ailment-top-context")).toBeInTheDocument();
    expect(screen.getByTestId("ailment-insight-summary")).toBeInTheDocument();
    expect(screen.getByTestId("ailment-kpi-chronic")).toHaveTextContent("Not Available");
    expect(screen.getByTestId("ailment-kpi-preventable")).toHaveTextContent("Not Available");
    expect(screen.getByTestId("ailment-kpi-risk-score")).toHaveTextContent("Not Available");
    ...
    expect(screen.getByTestId("ailment-share")).toBeInTheDocument();
    expect(screen.getByTestId("ailment-recurring")).toHaveTextContent("Cardiac");
    expect(screen.getByTestId("ailment-wellness-links")).toBeInTheDocument();
    expect(screen.getByTestId("ailment-chronic-unsupported")).toHaveTextContent("Not Available");
    expect(screen.getByTestId("ailment-alerts")).toBeInTheDocument();
    expect(screen.getByTestId("ailment-opportunities")).toBeInTheDocument();
    expect(screen.getByTestId("ailment-action-center")).toBeInTheDocument();
    expect(screen.getByTestId("ailment-evidence-footer")).toBeInTheDocument();
  });
  it("No-Data renders empty state", async () => {
    wire({ ailment: NODATA });
    renderWithProviders(<Ailment />);
